...
- 2026-06-18：详情页显式离线下载如果没有生成任何任务，会直接提示刷新重试，不再把空任务集合交给下载中心。
- 2026-06-18：详情页 Reader 自动获取章节时，如果站点解析没有生成下载任务，会明确失败并停止，不再加入空队列。
- 2026-06-18：移动端下载路径规划现在始终显示 App 私有保存区，避免旧桌面保存路径在 iPhone/iPad/Android 计划和提示里回流。
