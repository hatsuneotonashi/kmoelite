...
| Android 平板 | 实验预览源码路径存在；平板布局规则已纳入代码，但 Android 平板模拟器/真机完整验证仍未完成。 |
...
- 2026-06-08：修复 iPad/iPhone 登录表单输入辅助和站点 `e400` 提示，邮箱会去除首尾空格，密码按原样提交。
...
- Android 手机：已有调试 APK 路径和手机布局 smoke，可作为后续 Android 适配基础；当前仍不建议当作稳定日常版本。
