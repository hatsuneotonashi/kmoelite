...
| Android TV | 实验预览入口存在；Leanback launcher、TV runtime 识别和方向键焦点 smoke 已在 Android TV 模拟器验证，Reader/下载/缓存全链路仍未完成。 |
...
- 2026-06-08：修复 iPhone/iPad 显式下载保存区和错误提示，移动端下载先写入 App 私有保存区，再通过系统分享/导出到“文件”App。
...
- Android TV：已有实验启动和方向键焦点基础；下一步仍需补 Reader、下载、缓存清理和真设备验证。
