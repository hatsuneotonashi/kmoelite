...
| Android TV | 实验预览入口存在；Leanback launcher、TV runtime 识别、方向键焦点、remote Back 和 Reader OK/Back 键位已有源码支持与聚焦测试，Reader/下载/缓存全链路仍未完成。 |

当前状态和限制见 [docs/status](docs/status/README.md) 与 [docs/platforms](docs/platforms/README.md)。

## 最近更新

- 2026-06-17：补齐 Android TV/remote Back 与 Reader OK/Back 键位，避免遥控器只能进不能退。
...
- Android TV：已有实验启动、方向键焦点和 remote Back/OK 键位基础；下一步仍需补 Reader 下载、缓存清理和真设备验证。
