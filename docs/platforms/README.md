...
- App shell 已在 remote 输入下处理 Back 导航；Android native WebView bridge 可把 DPAD 方向键和 OK/Enter 交给前端；Reader 已在 TV 模拟器用合成本地 cache 验证 OK/Enter 显示 chrome、Back 关闭面板和返回上一页。
